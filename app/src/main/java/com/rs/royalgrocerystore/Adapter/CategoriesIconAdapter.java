...
public class CategoriesIconAdapter extends RecyclerView.Adapter<CategoriesIconAdapter.MYVIEWHOLDER> {

    List<CategoryIcon> list;
    RvListener listener;
    Context context;

    public CategoriesIconAdapter(List<CategoryIcon> list, RvListener listener) {
        this.list = list;
    ...
    public MYVIEWHOLDER onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View  view = LayoutInflater.from(parent.getContext()).inflate(R.layout.categories_with_icon_rec,parent,false);
